...
var _extends = _interopDefault(require("@babel/runtime/helpers/extends")), _objectWithoutProperties = _interopDefault(require("@babel/runtime/helpers/objectWithoutProperties")), _objectSpread = _interopDefault(require("@babel/runtime/helpers/objectSpread")), React = require("react"), ReactSelect = _interopDefault(require("react-select")), theme = require("@arch-ui/theme");
...
const indicatorStyles = (provided, _ref) => {
  ...
  let innerRef = _ref4.innerRef, styles = _ref4.styles, props = _objectWithoutProperties(_ref4, [ "innerRef", "styles" ]);
